...
def parse_opts():
    ...
    parser.add_argument(
        ...
        default='kinetics',
        type=str,
        help='Used dataset (activitynet | kinetics | ucf101 | hmdb51 | self)')
    parser.add_argument(
        '--n_classes',
        default=400,
        type=int,
    ...
    parser.add_argument('--warmup_epochs',
                        default=20,
                        type=int,
                        help='Warmup epochs if scheduler supports')
    ...
    parser.add_argument('--lr_scheduler',
                        default='multistep',
                        type=str,
                        help='Type of LR scheduler (multistep | plateau | warmup)')
    parser.add_argument(
    ...
    parser.add_argument('--export',
                        action='store_true',
                        help='If true, export is performed.')
